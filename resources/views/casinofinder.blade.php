...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <h1 class="text-center main-title margin-bottom-lg">Find your nearest casino</h1>
            <div id="users_address_container" class="row margin-bottom-lg hidden">
                <div class="col-md-6 col-md-offset-3">
                    <input type="text" name="users_address" id="users_address" class="form-control" placeholder="Start typing your address">
                </div>
            </div>
        </div>
    </div>
